...
> Visite a página clicando [aqui](https://matheus-reichemback-stang.github.io/EBAC-games_shop/).
...
Nesse projeto foi criado uma **Landing Page** de uma empresa fictícia que se chama ***Games Shop***. As tecnologias usadas para construir está página foram **HTML** e **CSS**. Caso ainda não tenha visto a página, clique [aqui](https://matheus-reichemback-stang.github.io/EBAC-games_shop/).
